...
// 0. От порученной Вам задачи зависит ключевой функционал предстоящего демо,
// Вы просидели над реализацией более 2-х рабочих дней (эстимейт -4 часа) и понимаете,
// что не знаете сколько еще времени нужно, демо послезавтра, Ваши действия ?
...
// Ширина элемента - 50px, высота - 50px
